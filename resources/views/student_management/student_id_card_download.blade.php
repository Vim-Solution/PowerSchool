<div class="card">
    <div class="card-body">
        <div id="card">
            <div id="c_left">
                <img src="{{ public_path($student->profile) }}" width="80px" height="100px" style="border:1px solid black;"><br>
                <div id="c_box">
            ...
            <div id="c_right">
                ...
                <table style="margin-top:23px;">
                    ...
                    <tr>
                        <td><i>Principal</i></td>
                        <td><img src="{{public_path(trans('img/img.sign'))}}" width="100px" height="30px"></td>
                    </tr>
                </table>
