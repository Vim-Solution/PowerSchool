       ...
       {{-- <div class="profile">
            ...
            <div class="profile__info" style="width: 100%;">
                <h3 style="color: #0D0A0A;position: relative;left: 18%;">
                    <b>{{ trans('subject_management/manage_test.manage_test_title') }}</b></h3><br>
                <form method="get" enctype="multipart/form-data"
                      action="{{ trans('settings/routes.manage_subject_test') . trans('settings/routes.get_subject')}}">
                    <ul class="icon-list">
                        <li>
                            <div class="row">
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        <label for="program"
                                               style="color: black;">@lang('subject_management/manage_test.select_class')</label>
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        <label for="program"
                                               style="color: black;">@lang('subject_management/manage_test.select_program')</label>
                        ...
                        <li>
                            <button type="submit" class="btn c-ewangclarks"
                                ...
                                <h6 class="text-white"><i
                                        class="zmdi zmdi-view-agenda"></i>@lang('actions/action.get_subject_list')</h6>
                            </button>
                            <br><br><br>
                        </li>
                    </ul>
