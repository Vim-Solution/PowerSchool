...
@section('title')
    @lang('account_management/reset_password.reset_password_header')
@endsection
@section('content')
    @if(session('status'))
        {!! session('status')!!}
        ...
        <div class="toolbar__search">
            <div class="toolbar__search">
                <form enctype="multipart/form-data" method="post"
                      action="{{ trans('settings/routes.password_reset') }}">
                    @csrf()
                    <div class="row" style="padding-top: 1%;">
                        <div class="col-sm-3 c-ewangclarks"
                             style="background-color:@lang('settings/theme.blue');position: relative;top: 10%;height: 50px;">
                        ...
                        <div class="col-sm-4">
                            <button type="submit" class="btn c-ewangclarks"
                                    style="width: 80%;background-color:@lang('settings/theme.blue');position: relative;top: ;"> @lang('account_management/edit_user.search')
                            </button>
                        </div>
                    </div>
                </form>
...
@section('script')
    <script type="text/javascript">
        ...
        var privName = '#' + "<?php echo trans('authorization/privilege.password_reset')?>";
