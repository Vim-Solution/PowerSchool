...
@section('title')
    @lang('account_management/reset_user.reset_user_header')
@endsection
    ...
    <div class="toolbar">
        ...
        <div class="toolbar__search">
            <form enctype="multipart/form-data" method="post"
                  action="{{ trans('settings/routes.reset_user') }}">
                @csrf()
                <div class="row" style="padding-top: 1%;">
                    <div class="col-sm-3 c-ewangclarks"
                         style="background-color:@lang('settings/theme.green');position: relative;top: 10%;height: 50px;">
                        <label class="text-white"
                               style="position: relative;left:22%;top: 30%;">{{  ucfirst(trans('account_management/reset_user.enter_email'))}}</label>
                    </div>
                    <div class="col-sm-5">
                    ...
                    <div class="col-sm-4">
                        <button type="submit" class="btn c-ewangclarks"
                                style="width: 80%;background-color:@lang('settings/theme.green');position: relative;top: ;"> @lang('account_management/edit_user.search')
                        </button>
                    </div>
                </div>
            </form>
...
@section('script')
    <script type="text/javascript">
        ...
        var privName = '#' + "<?php echo trans('authorization/privilege.reset_user')?>";
