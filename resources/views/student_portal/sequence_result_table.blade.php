{!! $header !!}
<div class=" card profile z-depth-4">
    ...
    <div class="profile__info">
        <ul class="icon-list">
            ...
            <li style="color: black">
                <i class="zmdi zmdi-calendar-check"></i>{{ \App\Sequence::getSequenceNameById($sequenceId) . ' ' . trans('general.result') . ', ' . $year }}
            </li>
        </ul>
    </div>
</div>
<div class="table-responsive">
    <table id="@lang('general.data_table')" class="table table-striped">
        ...
        <tr>
            ...
            <th>@lang('student_portal/result_portal.score')</th>
...
<br>
<a href="{{ trans('settings/routes.download_result_s')  . '/' . \App\Encrypter::encrypt($student->student_id). '/' .\App\Encrypter::encrypt($sequenceId) . '/' . \App\Encrypter::encrypt($year) }}"
