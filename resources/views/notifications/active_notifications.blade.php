@foreach ($activeNotifications as $activeNotification)
    @php $notifier = App\User::find($activeNotification->notifier_id) @endphp
    <a href="{{ trans('settings/routes.notifications') . '/' . App\Encrypter::encrypt($activeNotification->notification_id) }}"
       class="listview__item">
        ...
        <div class="listview__content">
            ...
            <p>{{ $activeNotification->notification_subject }}</p>
        </div>
    </a>
@endforeach
