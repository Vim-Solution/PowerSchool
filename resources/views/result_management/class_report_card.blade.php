...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body">
            @foreach($class_report_cards as $report_card)
                <div class="card">
                    <div class="card-body">
            ...
            @endforeach
            <a href="{{trans('settings/routes.auto_promote')}}" class="btn bg-green"
               style="width: 40%;position: relative;left: 30%;"><h6 class="text-white"><i
                        class="zmdi zmdi-refresh-sync"></i>{{trans('result_management/report_card.auto_promote')}}
                </h6></a><br><br>
            {!! $download_report_cards !!}<br><br>
        </div>
    </div>
