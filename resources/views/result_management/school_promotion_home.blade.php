...
@section('title')
    @lang('result_management/auto_promotion.auto_promotion_header')
@endsection
@section('content')
    @if (count($errors) > 0)
    ...
    <div class="card">
        <div class="profile">
            <div class="profile__img">
                <img src="{{asset(trans('img/img.book_logo_p'))}}" alt="" height="200px;" width="400px">
            </div>
            <div class="profile__info" style="width: 100%;">
                <h3 style="color: #0D0A0A;position: relative;left: 5%;">
                    <b>{{ trans('result_management/auto_promotion.auto_promotion_title') }}</b></h3><br><br>

                <ul class="icon-list">
                    <li>
                        <form method="post" enctype="multipart/form-data"
                              action="{{ trans('settings/routes.manage_class_promotion')}}">
                            @csrf
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="academic-year"
                                               style="color: black;">@lang('result_management/auto_promotion.select_academic_year')</label>
                                ...
                                <div class="col-sm-5"><br>
                                    <button type="submit" class="btn c-ewangclarks"
                                        ...
                                        <h6 class="text-white"><i
                                                class="zmdi zmdi-walk"></i>@lang('result_management/auto_promotion.get_auto_promotion')
                                        </h6>
                                    </button>
                                </div>
                            </div>
        ...
        <div class="card-body">
            {!!  $class_promotion_management_list  !!}
        </div>
    </div>
...
@section('script')
    ...
    <script type="text/javascript">
        ...
        var privName = '#' + "<?php echo trans('authorization/privilege.manage_class_promotion')?>";
