...
@section('title')
    @lang('auditing_management/audit_user_actions.audit_user_action_header')
@endsection
@section('content')
    <br>
    @if (count($errors) > 0)
    ...
    <div class="card">
        <div class="profile">
            ...
            <div class="profile__info" style="width: 100%;">
                <h3 style="color: #0D0A0A;position: relative;left: 20%;">
                    <b>{{ trans('auditing_management/audit_user_actions.audit_user_action_title') }}</b></h3><br><br>

                <form method="post" enctype="multipart/form-data"
                      action="{{ trans('settings/routes.audit_user_actions')}}">
                    @csrf
                    <ul class="icon-list">
                        <li>
                            <div class="row">
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        <label for="action"
                                               style="color: black;">@lang('auditing_management/audit_user_actions.select_action')</label>
                                ...
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        <label for="academic-year"
                                               style="color: black;">@lang('auditing_management/audit_user_actions.select_academic_year')</label>
        ...
        @section('script')
            ...
            <script type="text/javascript">
                ...
                var privName = '#' + "<?php echo trans('authorization/privilege.audit_user_actions')?>";
