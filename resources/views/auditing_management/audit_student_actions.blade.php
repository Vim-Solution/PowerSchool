...
@section('title')
    @lang('auditing_management/audit_student_actions.audit_student_action_header')
@endsection
@section('content')
    <br>
    @if (count($errors) > 0)
    ...
    <div class="card">
        <div class="profile">
            ...
            <div class="profile__info" style="width: 100%;">
                <h3 style="color: #0D0A0A;position: relative;left: 1%;">
                    <b>{{ trans('auditing_management/audit_student_actions.audit_student_action_title') }}</b></h3><br><br>

                <form method="post" enctype="multipart/form-data"
                      action="{{ trans('settings/routes.audit_student_actions')}}">
                    @csrf
                    <ul class="icon-list">
                        <li>
                            <div class="row">
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        <label for="action"
                                               style="color: black;">@lang('auditing_management/audit_student_actions.select_action')</label>
                                        <select class="select2" name="action">
                                            {!! App\Setting::getActionListMany() !!}
                                        </select>
                                    </div>
                                </div>
                                <div class="col-sm-5">
                                    <div class="form-group">
                                        <label for="academic-year"
                                               style="color: black;">@lang('auditing_management/audit_student_actions.select_academic_year')</label>
        ...
        @section('script')
            ...
            <script type="text/javascript">
                ...
                var privName = '#' + "<?php echo trans('authorization/privilege.audit_student_actions')?>";
