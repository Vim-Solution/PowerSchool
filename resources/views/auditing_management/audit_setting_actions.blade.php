...
@section('title')
    @lang('auditing_management/audit_setting_actions.audit_setting_action_header')
@endsection
@section('content')
    <br>
    @if (count($errors) > 0)
    ...
    <div class="card">
        <div class="profile">
            ...
            <div class="profile__info" style="width: 100%;">
                <h3 style="color: #0D0A0A;position: relative;left: 10%;">
                    <b>{{ trans('auditing_management/audit_setting_actions.audit_setting_action_title') }}</b></h3>
                <br>

                <form method="post" enctype="multipart/form-data"
                      action="{{ trans('settings/routes.audit_setting_actions')}}">
                    @csrf
                    <ul class="icon-list">
                        <li>
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label for="academic-year"
                                               style="color: black;">@lang('auditing_management/audit_setting_actions.select_academic_year')</label>
                                ...
                                <div class="col-sm-5"><br>
                                    <button type="submit" class="btn c-ewangclarks"
                                        ...
                                        <h6 class="text-white"><i
                                                class="zmdi zmdi-local-activity"></i>@lang('actions/action.get_activities')
                                        </h6>
                                    </button>
                                </div>
                            </div>
        ...
        @section('script')
            ...
            <script type="text/javascript">
                ...
                var privName = '#' + "<?php echo trans('authorization/privilege.audit_setting_actions')?>";
